...
const ROLES = [
  ...
  },
  {
    ...
    btnClass: 'btn-outline border-amber-500/50 text-amber-400 hover:bg-amber-500/10',
  },
  {
    icon: Building2,
    ...
    btnClass: 'btn-outline border-blue-500/50 text-blue-400 hover:bg-blue-500/10',
  },
]
      ...
      <div className="section-container">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-gray-400 text-lg">
            The interface adapts to who you are. Each role gets a tailored experience
            optimized for their workflow and device.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {ROLES.map((role) => (
            ...
            >
              {/* Gradient top accent */}
              <div className={`absolute inset-x-0 top-0 h-32 bg-gradient-to-b ${role.color} pointer-events-none`} aria-hidden="true" />
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className={`badge border ${role.badge} text-xs`}>{role.role}</span>
                </div>

                {/* Title */}
                <h3 className="font-display font-bold text-xl text-white mb-1">{role.role}</h3>
                <p className="text-primary-400 text-sm font-medium mb-4">{role.tagline}</p>
